              ...
              children: <Widget>[
                GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    curve: Curves.ease,
                    height: search ? MediaQuery.of(context).size.height * 0.6 : MediaQuery.of(context).size.height * 0.4,
                    child: CustomPaint(
                ...
                GestureDetector(
                  ...
                  child: AnimatedContainer(
                    duration: Duration(milliseconds: 500),
                    curve: Curves.ease,
                    height: search ? MediaQuery.of(context).size.height * 0.4 : MediaQuery.of(context).size.height * 0.6,
                    child: Container(
